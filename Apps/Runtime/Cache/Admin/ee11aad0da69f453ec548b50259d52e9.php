...
<div id="urHere">BoolCMS 管理中心<b>></b><strong>添加单页面</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
  ...
  <form action="/bool_cms/admin.php/Page/edit/id/2" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right">单页面标题</td>
       <td>
        <input type="text" name="name" value="<?php echo ($info["name"]); ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">别名</td>
       <td>
        <input type="text" name="alias" value="<?php echo ($info["alias"]); ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       ...
       <td>
        <select name="parent_id">
         ...
         <?php if(is_array($menu_list)): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["child_id"]); ?>" <?php echo $info['parent_id']==$vo['child_id'] ?'selected="selected" ':null ;?>> <?php echo ($vo['level']?'├':null); echo str_repeat('┈',$vo['level']); echo ($vo["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
      ...
      <tr>
       ...
       <td>
        <input type="text" name="keywords" value="<?php echo ($info["keywords"]); ?>" size="90" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">简单描述</td>
       <td>
        <input type="text" name="description" value="<?php echo ($info["description"]); ?>" size="90" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td></td>
