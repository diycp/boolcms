    ...
    <tr>
     ...
     <tr>
      <td width="350" valign="top">
       ...
       <form action="/bool_cms/admin.php/Show/add" method="post" enctype="multipart/form-data"  <?php echo $info['id']?'class="formEdit"':'class="forms"';?>>
         ...
         <tr>
          <td><b>幻灯图片</b>
           <input type="file" name="img" class="inpFlie" />
            <input type="hidden" name="img" class="inpFlie" value="<?php echo ($info["img"]); ?>"/>
          </td>
         </tr>
         <tr>
          <td><b>链接地址</b>
...
<?php if(is_array($show)): $i = 0; $__LIST__ = $show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php echo $vo['id']==$info['id']?'class="active" ':null ;?> >
         <td><a href="/bool_cms/Public/<?php echo ($vo["img"]); ?>" target="_blank"><img src="/bool_cms/Public/<?php echo ($vo["img"]); ?>" width="120" /></a></td>
         ...
         <td align="center">
             ...
             <a href="javascript:;" onclick="deletes('/bool_cms/admin.php/Show/delete/id/<?php echo ($vo["id"]); ?>')">删除</a>
         </td>
