...
<div id="urHere">BoolCMS 管理中心<b>></b><strong>自定义导航栏</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <div class="idTabs">
      ...
      <div class="items">
        <div id="nav_add">
         <form action="/bool_cms/admin.php/Menu/add" method="post">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
           ...
           <tr>
            ...
            <td>
             <label for="type_0">
              <input type="radio" name="type" id="type_0" value="main" checked="checked"  onChange="callback('/bool_cms/admin.php/Menu/AjaxMenu',this.value)">
              主导航</label>
             <label for="type_1">
              <input type="radio" name="type" id="type_1" value="top"  onChange="callback('/bool_cms/admin.php/Menu/AjaxMenu',this.value)">
              顶部</label>
             <label for="type_2">
              <input type="radio" name="type" id="type_2" value="bottom" onChange="callback('/bool_cms/admin.php/Menu/AjaxMenu',this.value)">
              底部</label>
            </td>
           </tr>
           <tr>
           ...
           <tr>
              ...
              <td>
                  <select name="page_id">
                      ...
                      <?php if(is_array($page_list)): $i = 0; $__LIST__ = $page_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                  </select>
              </td>
           </tr>
           <tr>
