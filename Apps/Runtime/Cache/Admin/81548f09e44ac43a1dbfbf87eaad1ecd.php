...
<!--         <ul>
   ...
   <!-- 当前位置 -->
<div id="urHere">BoolCMS 管理中心<b>></b><strong>单页面列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="/bool_cms/admin.php/Page/add" class="actionBtn">添加单页面</a>单页面列表</h3>
      <div class="page">


<?php if(is_array($page_list)): $k = 0; $__LIST__ = $page_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><dl <?php echo $k>1 ?'class="child1" ':null;?>>
        <dt><strong><?php echo ($vo["name"]); ?></strong><p><?php echo ($vo["alias"]); ?></p></dt>
        <dd><a href="/bool_cms/admin.php/Page/edit/id/<?php echo ($vo["id"]); ?>">编辑</a> | <a href="javascript:;" onclick="deletes(' /bool_cms/admin.php/Page/delete/id/<?php echo ($vo["id"]); ?>')" >删除</a></dd>
