...
<div id="urHere">BoolCMS 管理中心<b>></b><strong>添加分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="/bool_cms/admin.php/Category/edit/id/18" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right">分类名称</td>
       <td>
        <input type="text" name="cat_name" value="<?php echo ($info["cat_name"]); ?>" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
  ...
  <?php if(is_array($menu_list)): $i = 0; $__LIST__ = $menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["child_id"]); ?>"  
          ...
          <?php echo $vo['child_id']==$info['child_id']?'disabled="disabled" style="background:#60BBFF;""':null;?>
          > 
          <?php echo ($vo['level']?'├':null); echo str_repeat('┈',$vo['level']); echo ($vo["cat_name"]); ?>
      ...
      <tr>
       ...
       <td>
        <textarea name="desc" cols="60" rows="4" class="textArea"><?php echo ($info["desc"]); ?></textarea>
       </td>
      </tr>
      <tr>
