...
<!--         <ul>
        ...
        <ul>
            ...
            <li><a href="article.html"><i class="article"></i><em>内容列表</em></a></li>
        </ul>
        <ul class="bot">
   ...
   <!-- 当前位置 -->
<div id="urHere">BoolCMS 管理中心<b>></b><strong>添加分类</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="/bool_cms/admin.php/Category/index" class="actionBtn">内容分类</a>添加分类</h3>

    <form action="/bool_cms/admin.php/Category/add" method="post">
